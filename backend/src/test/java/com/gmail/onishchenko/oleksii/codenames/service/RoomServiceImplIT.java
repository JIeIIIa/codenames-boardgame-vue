...
class RoomServiceImplIT {
    ...
    @Test
    void selectWordWhenRoomNotFound() {
        //When
        assertThrows(RoomNotFoundException.class, () -> instance.selectWord(123L, 7L));
    }

    @Test
    void selectWordWhenWordNotFound() {
        //When
        assertThrows(CardNotFoundException.class, () -> instance.selectWord(-10L, 7L));
    }
    ...
    void selectWordSuccess() {
        //When
        instance.selectWord(-10L, 7L);
